"""Тест кейс для UI запроса register successful"""
import allure
import pytest
...
@allure.suite("ui_register_successful")
@allure.title("Запрос на регистрацию с валидными параметрами")
@pytest.mark.parametrize(
    ("request_name", "request_parameters"), load_data("register_data", "ui_data")
)
def test_ui_register_valid_parameters(
